          ...
          <div class="widget widget-one">
            ...
            <div class="w-chart">
              <div class="w-chart-section text-center" style="height: 85px;">
                <div class="w-detail">
                  <p class="w-title">Lessons I've Taken</p>
              ...
              <div class="w-chart-section text-center">
                <div class="w-detail">
                  <p class="w-title">Profit On My Investments</p>
                  <p class="w-stats">Coming Soon</p>
                </div>
                <div class="w-chart-render-one">
          ...
          <div class="widget widget-account-invoice-two" style="height: 220px;">
            <div class="widget-content">
              <div class="account-box">
                <div class="info">
                  <h5 class="">New And Exciting Courses Available!</h5>
                <p class="inv-balance">Check them out!</p>
                </div>
                <div class="acc-action">
                  <div class="">
                    <a href="/#/student/dashboard/all_courses"
                          ><svg
                        ...
                        ></a>
                        <a href="/#/student/dashboard/my_courses"
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                  ...
                  <a href="/#/student/dashboard/all_courses">Go!</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
          <div class="widget widget-card-four">
            <div class="widget-content">
              <div class="w-content">
                <div class="w-info">
                  <h6 class="value">Real-time Signals & Charts</h6>
        ...
        >
          <div class="widget widget-chart-three">
            ...
            <div class="widget-content">
              ...
              <div style="height: 30em; background-color: #fff;">
                <h3 class="text-danger p-4 mb-3 text-center">Coming Soon</h3>
                <img style="height: 200px; margin: auto; display: block;" src="@/assets/img/savings.svg" alt="Optimus Pro: Investments" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="widget-content">
              <div class="mt-container mx-auto">
                <div class="timeline-line">
                  <div v-for="notif in notifs.slice().reverse()" :key="notif.notification_id" class="item-timeline timeline-new">
                    <div class="t-dot">
                      <div class="t-success">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
...
import { listMyCourses, getNotifs } from "../../utils/endpoints";
...
export default class Dashboard extends Vue {
  ...
  mounted() {
    if (localStorage.getItem("user_id") == null) this.$router.push("/auth");
    this.getLessons();
    this.getNotifs();
  ...
  getLessons() {
    axios
      .get(`${listMyCourses}/${this.user_id}`)
